...
namespace BinaryEx
{
    public static partial class BinUtils
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void ReadBytes(this Span<byte> buff, ref int offset, byte[] output, UInt32 count)
        {
            offset += ReadBytes(buff, offset, output, count);
        }

        public static void ReadCountLE<T>(this Span<byte> buff, ref int offset, T[] output, UInt32 count) where T : unmanaged
        {
